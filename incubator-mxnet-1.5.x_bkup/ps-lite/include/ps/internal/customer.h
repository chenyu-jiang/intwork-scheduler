...
class Customer {
 public:
  ...
  void Log(std::chrono::nanoseconds start_time, std::string str);
 ...
 private:
  ...
  // *** Task for profileing (marker does not show in Chrome tracing) ** //
  mxnet::profiler::ProfileDomain* customer_domain;
  mxnet::profiler::ProfileTask* accept_task;
