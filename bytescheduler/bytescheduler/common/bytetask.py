...
class ByteTask(with_metaclass(ABCMeta)):
    ...
    def __init__(self, name, id, tensor, op, 
        ...
        Args:
            ...
            id: The tensor id of task, must be unique during a single training step.
        ...
        self.end_callback_context = None      
    ...
    def prepare(self, start_callback=None, start_callback_context=None):
    ...
    def _partition_tensor_v2(self, size, num_workers=None):
